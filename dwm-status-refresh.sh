...
xsetroot -name " MEN $(print_mem) | $(dwm_alsa) | $( acpi -b | awk '{ print $3, $4 }' | tr -d ',') | $(print_date) "
#xsetroot -name "  💿 $(print_mem)M | $(dwm_alsa) [🔋$( acpi -b | awk '{ print $3, $4 }' | tr -d ',' | tr -d 'Discharging')] |$(show_record) $(print_date) "
